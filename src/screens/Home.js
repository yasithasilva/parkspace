...
import { Search, Star, DirectionsCar, AttachMoney, AccessTime } from "@mui/icons-material";
...
const parkingPlaces = [
  { id: 1, name: "Majestic City", rating: 4.5, price: "Rs. 100/hr", spots: 4, distance: "5 min away", image: LocationMC },
  { id: 2, name: "Liberty Plaza", rating: 4.3, price: "Rs. 120/hr", spots: 6, distance: "7 min away", image: LocationMC },
  { id: 3, name: "Odel Parking", rating: 4.7, price: "Rs. 150/hr", spots: 3, distance: "4 min away", image: LocationMC }
];
...
const HomeScreen = () => {
  ...
  return (
    <Box sx={{ width: "100vw", height: "100vh", padding: "16px", boxSizing: "border-box", overflowY: "auto" }}>
      <Typography variant="h6">Havelock City | 5km</Typography>

    
      <Card sx={{ backgroundColor: "#E8F5E9", padding: "16px", borderRadius: "12px", marginY: 2 }}>
        <CardContent>
          ...
          <Button variant="outlined" sx={{ marginTop: 1 }}>Renew</Button>
        </CardContent>
      </Card>


      <Typography variant="body1" fontWeight="bold">Select Vehicle Type</Typography>
        ...
        {vehicleTypes.map((type) => (
          <Box
            ...
            sx={{
              width: "18%",
              padding: "8px",
              backgroundColor: selectedVehicle === type.id ? "#cce5ff" : "#F5F5F5",
              border: selectedVehicle === type.id ? "2px solid #007bff" : "none",
              borderRadius: "8px",
              display: "flex",
      ...
      <Typography variant="body1" fontWeight="bold" marginTop={2}>Nearby Parking Places</Typography>
      <Box 
        sx={{ 
          display: "flex", 
          overflowX: "auto", 
      ...
      >
        {parkingPlaces.map((place) => (
          <Card key={place.id} sx={{ minWidth: "320px", display: "flex", alignItems: "center", borderRadius: "12px", padding: "12px" }}>
            
           
            <Box sx={{ width: "90px", height: "90px", borderRadius: "8px", overflow: "hidden", marginRight: 2 }}>
            ...
            <CardContent sx={{ flex: 1, padding: "0" }}>
              ...
              <Button variant="outlined" sx={{ marginTop: 1, textTransform: "none", fontWeight: "bold" }}>Book Now</Button>
            </CardContent>
          </Card>
        ))}
      </Box>
